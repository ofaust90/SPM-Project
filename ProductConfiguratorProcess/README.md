...
<!-- HTML snippet for index page
  <tr>
    <td><img src="snippets/ProductConfiguratorProcess/src/main/resources/process.png" width="100"></td>
    <td><a href="snippets/ProductConfiguratorProcess">Camunda BPM Process Application</a></td>
    <td>A Process Application for [Camunda BPM](http://docs.camunda.org).</td>
  </tr>
-->
<!-- Tweet
New @Camunda example: Camunda BPM Process Application - A Process Application for [Camunda BPM](http://docs.camunda.org). https://github.com/camunda-consulting/code/tree/master/snippets/ProductConfiguratorProcess
-->